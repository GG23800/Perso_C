...
void trigg();
void on_trigger_acquisition(int voie, float *buffer_float, uint32_t buffer_length);
...
void on_trigger_acquisition(int voie, float *buffer_float, uint32_t buffer_length)
{
	...
	if (voie==1) {rp_AcqGetLatestDataV(RP_CH_1, &buffer_length, buffer_float);}
	else {rp_AcqGetLatestDataV(RP_CH_2, &buffer_length, buffer_float);}
}
...
{
	trigg(data_RP->delay);
	on_trigger_acquisition_int16(1,data_RP->buffer_float, data_RP->buffer_length);
        send_int16_via_tcp(line, data_RP->buffer_int16, data_RP->buffer_float, data_RP->buffer_length, data_RP->client_list);
        on_trigger_acquisition_int16(2,data_RP->buffer_float, data_RP->buffer_length);
        send_int16_via_tcp(line, data_RP->buffer_int16, data_RP->buffer_float, data_RP->buffer_length, data_RP->client_list);
